...
def main():
    ...
    parser.add_argument('-j', '--json', type=str, required=True, help='Full path to jason file')
    ...
    while True:
        ...
        result = cv2.bitwise_and(image, image, mask=mask) # junçao de imagens

        cv2.imshow('Color Segmenter', mask)
